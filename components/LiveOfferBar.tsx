  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="mx-1.5 bg-black text-white p-0.5 rounded-full font-bold select-all tracking-normal inline-block align-middle leading-none" style={{ fontSize: 'inherit' }}>
          {promoCode}
        </span>
